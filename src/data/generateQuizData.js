...
const catalog = {
  indo: [
    ...
    { title: 'Bawa Dia Kembali', artist: 'Mahalini', year: '2019', genre: 'Indo Pop' },
    ...
    { title: 'Gala Bunga Matahari', artist: 'Sal Priadi', year: '2024', genre: 'Indo Pop' },
    { title: 'Dari Planet Lain', artist: 'Sal Priadi', year: '2024', genre: 'Indo Pop' },
    { title: 'Mesra-mesraannya kecil-kecilan dulu', artist: 'Sal Priadi', year: '2022', genre: 'Indo Pop' },
    { title: 'Amin Paling Serius', artist: 'Sal Priadi ft. Nadin Amizah', year: '2019', genre: 'Indo Pop' },
    ...
    { title: 'Semua Aku Dirayakan', artist: 'Nadin Amizah', year: '2023', genre: 'Indo Indie' },
    ...
    { title: 'Tak Kan Hilang', artist: 'Budi Doremi', year: '2022', genre: 'Indo Pop' },
    { title: 'Melukis Senja', artist: 'Budi Doremi', year: '2020', genre: 'Indo Pop' },
    { title: 'Doremi', artist: 'Budi Doremi', year: '2011', genre: 'Indo Pop' },
    { title: 'Mesin Waktu', artist: 'Budi Doremi', year: '2021', genre: 'Indo Pop' },
    { title: 'Akad', artist: 'Payung Teduh', year: '2017', genre: 'Indo Pop' },
    { title: 'Menuju Senja', artist: 'Payung Teduh', year: '2012', genre: 'Indo Indie' },
    { title: 'Resah', artist: 'Payung Teduh', year: '2014', genre: 'Indo Indie' },
    { title: 'Untuk Perempuan Yang Sedang Dalam Pelukan', artist: 'Payung Teduh', year: '2012', genre: 'Indo Indie' },
    ...
    { title: 'Cincin', artist: 'Hindia', year: '2023', genre: 'Indo Indie' },
    { title: 'Berdansalah, Karir Ini Tak Ada Artinya', artist: 'Hindia', year: '2023', genre: 'Indo Indie' },
    // Pop & Rock Legendaris
    { title: 'Dan...', artist: 'Sheila On 7', year: '2000', genre: 'Indo Rock' },
    { title: 'Sephia', artist: 'Sheila On 7', year: '2000', genre: 'Indo Pop' },
    { title: 'Sebuah Kisah Klasik', artist: 'Sheila On 7', year: '2000', genre: 'Indo Pop' },
    { title: 'Hari Bersamanya', artist: 'Sheila On 7', year: '2011', genre: 'Indo Pop' },
    { title: 'Mudah Saja', artist: 'Sheila On 7', year: '2009', genre: 'Indo Pop' },
    { title: 'Lapang Dada', artist: 'Sheila On 7', year: '2014', genre: 'Indo Pop' },
    { title: 'Pejantan Tangguh', artist: 'Sheila On 7', year: '2004', genre: 'Indo Rock' },
    { title: 'Betapa', artist: 'Sheila On 7', year: '2008', genre: 'Indo Pop' },
    ...
    { title: 'Cinta Kan Membawamu Kembali', artist: 'Dewa 19', year: '1995', genre: 'Indo Pop' },
    { title: 'Separuh Aku', artist: 'NOAH', year: '2012', genre: 'Indo Pop' },
    { title: 'Kupu-Kupu Malam', artist: 'NOAH', year: '2022', genre: 'Indo Pop' },
    { title: 'Yang Terdalam', artist: 'Peterpan', year: '2003', genre: 'Indo Pop' },
    { title: 'Mungkin Nanti', artist: 'Peterpan', year: '2004', genre: 'Indo Pop' },
    { title: 'Ada Apa Denganmu', artist: 'Peterpan', year: '2004', genre: 'Indo Pop' },
    { title: 'Bintang di Surga', artist: 'Peterpan', year: '2004', genre: 'Indo Pop' },
    { title: 'Semua Tentang Kita', artist: 'Peterpan', year: '2003', genre: 'Indo Pop' },
    { title: 'Ku Katakan Dengan Indah', artist: 'Peterpan', year: '2004', genre: 'Indo Pop' },
    ...
    { title: 'Sunny (Cinta Pertama)', artist: 'Bunga Citra Lestari', year: '2006', genre: 'Indo Pop' },
    ...
    { title: 'Sigar', artist: 'Denny Caknan', year: '2024', genre: 'Indo Koplo' },
    { title: 'Pamer Bojo', artist: 'Didi Kempot', year: '2019', genre: 'Indo Koplo' },
    { title: 'Banyu Langit', artist: 'Didi Kempot', year: '2016', genre: 'Indo Koplo' },
    { title: 'Stasiun Balapan', artist: 'Didi Kempot', year: '1999', genre: 'Indo Koplo' },
    { title: 'Korban Janji', artist: 'Guyon Waton', year: '2018', genre: 'Indo Koplo' },
    { title: 'Perlahan', artist: 'Guyon Waton', year: '2020', genre: 'Indo Koplo' },
    { title: 'Sanes', artist: 'Guyon Waton ft. Denny Caknan', year: '2023', genre: 'Indo Koplo' },
    { title: 'Nemen', artist: 'NDX AKA / GildCoustic', year: '2023', genre: 'Indo Koplo' }
  ],
  western: [
    // Pop & Modern Billboard
    ...
    { title: 'Fortnight', artist: 'Taylor Swift ft. Post Malone', year: '2024', genre: 'Western Pop' },
    ...
    { title: 'Die For You', artist: 'The Weeknd', year: '2016', genre: 'Western Pop' },
    { title: 'Can\'t Feel My Face', artist: 'The Weeknd', year: '2015', genre: 'Western Pop' },
    { title: 'The Hills', artist: 'The Weeknd', year: '2015', genre: 'Western Pop' },
    { title: 'Creepin\'', artist: 'Metro Boomin ft. The Weeknd & 21 Savage', year: '2022', genre: 'Western Hip-Hop' },
    ...
    { title: 'Shivers', artist: 'Ed Sheeran', year: '2021', genre: 'Western Pop' },
    ...
    { title: 'Peaches', artist: 'Justin Bieber ft. Daniel Caesar', year: '2021', genre: 'Western Pop' },
    ...
    { title: 'Hymn for the Weekend', artist: 'Coldplay ft. Beyonce', year: '2015', genre: 'Western Pop' },
    { title: 'Paradise', artist: 'Coldplay', year: '2011', genre: 'Western Pop' },
    ...
    { title: 'I Want It That Way', artist: 'Backstreet Boys', year: '1999', genre: 'Western 90s' },
    { title: 'Everybody (Backstreet\'s Back)', artist: 'Backstreet Boys', year: '1997', genre: 'Western 90s' },
    { title: 'As Long As You Love Me', artist: 'Backstreet Boys', year: '1997', genre: 'Western 90s' },
    ...
    { title: 'Wake Me Up', artist: 'Avicii', year: '2013', genre: 'Western EDM' },
    { title: 'Waiting for Love', artist: 'Avicii', year: '2015', genre: 'Western EDM' },
    { title: 'The Nights', artist: 'Avicii', year: '2014', genre: 'Western EDM' },
    { title: 'Levels', artist: 'Avicii', year: '2011', genre: 'Western EDM' },
    { title: 'Titanium', artist: 'David Guetta ft. Sia', year: '2011', genre: 'Western EDM' },
    { title: 'Something Just Like This', artist: 'The Chainsmokers & Coldplay', year: '2017', genre: 'Western EDM' },
    { title: 'Closer', artist: 'The Chainsmokers ft. Halsey', year: '2016', genre: 'Western EDM' },
    { title: 'Don\'t Let Me Down', artist: 'The Chainsmokers ft. Daya', year: '2016', genre: 'Western EDM' }
  ],
  japan: [
    // Anime Openings & OST
    { title: 'Unravel', artist: 'TK from Ling Tosite Sigure', year: '2014', genre: 'Anime OST (Tokyo Ghoul)' },
    { title: 'Gurenge', artist: 'LiSA', year: '2019', genre: 'Anime OST (Demon Slayer)' },
    { title: 'Homura', artist: 'LiSA', year: '2020', genre: 'Anime OST (Demon Slayer Movie)' },
    { title: 'Crossing Field', artist: 'LiSA', year: '2012', genre: 'Anime OST (Sword Art Online)' },
    { title: 'Catch the Moment', artist: 'LiSA', year: '2017', genre: 'Anime OST (SAO Movie)' },
    { title: 'Shinzou wo Sasageyo', artist: 'Linked Horizon', year: '2017', genre: 'Anime OST (Attack on Titan)' },
    { title: 'Guren no Yumiya', artist: 'Linked Horizon', year: '2013', genre: 'Anime OST (Attack on Titan)' },
    { title: 'The Rumbling', artist: 'SiM', year: '2022', genre: 'Anime OST (Attack on Titan Final)' },
    { title: 'Red Swan', artist: 'YOSHIKI ft. HYDE', year: '2018', genre: 'Anime OST (Attack on Titan S3)' },
    { title: 'Akuma no Ko', artist: 'Ai Higuchi', year: '2022', genre: 'Anime OST (Attack on Titan Final)' },
    { title: 'Zenzenzense', artist: 'RADWIMPS', year: '2016', genre: 'Anime OST (Kimi no Na wa)' },
    { title: 'Sparkle', artist: 'RADWIMPS', year: '2016', genre: 'Anime OST (Kimi no Na wa)' },
    { title: 'Nandemonaiya', artist: 'RADWIMPS', year: '2016', genre: 'Anime OST (Kimi no Na wa)' },
    { title: 'Grand Escape', artist: 'RADWIMPS ft. Toko Miura', year: '2019', genre: 'Anime OST (Weathering with You)' },
    { title: 'Suzume', artist: 'RADWIMPS ft. Toaka', year: '2022', genre: 'Anime OST (Suzume)' },
    { title: 'Idol', artist: 'YOASOBI', year: '2023', genre: 'Anime OST (Oshi no Ko)' },
    { title: 'Yoru ni Kakeru (Racing into the Night)', artist: 'YOASOBI', year: '2019', genre: 'J-Pop' },
    { title: 'Monster', artist: 'YOASOBI', year: '2021', genre: 'Anime OST (Beastars)' },
    { title: 'Kaibutsu', artist: 'YOASOBI', year: '2021', genre: 'Anime OST (Beastars)' },
    { title: 'Gunjou (Blue)', artist: 'YOASOBI', year: '2020', genre: 'J-Pop' },
    { title: 'Yuusha', artist: 'YOASOBI', year: '2023', genre: 'Anime OST (Frieren)' },
    { title: 'Shukufuku (The Blessing)', artist: 'YOASOBI', year: '2022', genre: 'Anime OST (Gundam)' },
    { title: 'Blue Bird', artist: 'Ikimonogakari', year: '2008', genre: 'Anime OST (Naruto Shippuden)' },
    { title: 'Hotaru no Hikari', artist: 'Ikimonogakari', year: '2009', genre: 'Anime OST (Naruto Shippuden)' },
    { title: 'Silhouette', artist: 'KANA-BOON', year: '2014', genre: 'Anime OST (Naruto Shippuden)' },
    { title: 'Baton Road', artist: 'KANA-BOON', year: '2017', genre: 'Anime OST (Boruto)' },
    { title: 'Sign', artist: 'FLOW', year: '2010', genre: 'Anime OST (Naruto Shippuden)' },
    { title: 'GO!!!', artist: 'FLOW', year: '2004', genre: 'Anime OST (Naruto)' },
    { title: 'Colors', artist: 'FLOW', year: '2006', genre: 'Anime OST (Code Geass)' },
    { title: 'Kaikai Kitan', artist: 'Eve', year: '2020', genre: 'Anime OST (Jujutsu Kaisen)' },
    { title: 'Dramaturgy', artist: 'Eve', year: '2017', genre: 'J-Pop' },
    { title: 'Ao no Sumika (Where Our Blue Is)', artist: 'Tatsuya Kitani', year: '2023', genre: 'Anime OST (Jujutsu Kaisen S2)' },
    { title: 'Specialz', artist: 'King Gnu', year: '2023', genre: 'Anime OST (Jujutsu Kaisen Shibuya)' },
    { title: 'Hakujitsu', artist: 'King Gnu', year: '2019', genre: 'J-Pop' },
    { title: 'Ichizu', artist: 'King Gnu', year: '2021', genre: 'Anime OST (Jujutsu Kaisen 0)' },
    { title: 'Sakayume', artist: 'King Gnu', year: '2021', genre: 'Anime OST (Jujutsu Kaisen 0)' },
    { title: 'Kick Back', artist: 'Kenshi Yonezu', year: '2022', genre: 'Anime OST (Chainsaw Man)' },
    { title: 'Peace Sign', artist: 'Kenshi Yonezu', year: '2017', genre: 'Anime OST (My Hero Academia)' },
    { title: 'Lemon', artist: 'Kenshi Yonezu', year: '2018', genre: 'J-Pop' },
    { title: 'Loser', artist: 'Kenshi Yonezu', year: '2016', genre: 'J-Pop' },
    { title: 'Chikyuugi (Spinning Globe)', artist: 'Kenshi Yonezu', year: '2023', genre: 'Anime OST (Boy and the Heron)' },
    { title: 'Bling-Bang-Bang-Born', artist: 'Creepy Nuts', year: '2024', genre: 'Anime OST (Mashle S2)' },
    { title: 'Otonoke', artist: 'Creepy Nuts', year: '2024', genre: 'Anime OST (Dandadan)' },
    { title: 'Usseewa', artist: 'Ado', year: '2020', genre: 'J-Pop' },
    { title: 'New Genesis (Shin Jidai)', artist: 'Ado', year: '2022', genre: 'Anime OST (One Piece Film Red)' },
    { title: 'Show', artist: 'Ado', year: '2023', genre: 'J-Pop' },
    { title: 'Kura Kura', artist: 'Ado', year: '2023', genre: 'Anime OST (Spy x Family S2)' },
    { title: 'Kawaikute Gomen', artist: 'HoneyWorks', year: '2022', genre: 'J-Pop' },
    { title: 'Renai Circulation', artist: 'Kana Hanazawa', year: '2009', genre: 'Anime OST (Bakemonogatari)' },
    { title: 'Again', artist: 'YUI', year: '2009', genre: 'Anime OST (Fullmetal Alchemist)' },
    { title: 'InuYasha - Fukai Mori', artist: 'Do As Infinity', year: '2001', genre: 'Anime OST (InuYasha)' },
    { title: 'Cry Baby', artist: 'Official HIGE DANdism', year: '2021', genre: 'Anime OST (Tokyo Revengers)' },
    { title: 'Pretender', artist: 'Official HIGE DANdism', year: '2019', genre: 'J-Pop' },
    { title: 'Mixed Nuts', artist: 'Official HIGE DANdism', year: '2022', genre: 'Anime OST (Spy x Family)' },
    { title: 'I LOVE...', artist: 'Official HIGE DANdism', year: '2020', genre: 'J-Pop' }
  ],
  korea: [
    // K-Pop Hits Gen 2, 3, 4, 5
    ...
    { title: 'You & Me', artist: 'JENNIE', year: '2023', genre: 'K-Pop' },
    { title: 'On The Ground', artist: 'ROSE', year: '2021', genre: 'K-Pop' },
    { title: 'APT.', artist: 'ROSE & Bruno Mars', year: '2024', genre: 'K-Pop / Global' },
    ...
    { title: 'Cookie', artist: 'NewJeans', year: '2022', genre: 'K-Pop' },
    ...
    { title: 'Kitsch', artist: 'IVE', year: '2023', genre: 'K-Pop' },
    ...
    { title: 'UNFORGIVEN', artist: 'LE SSERAFIM ft. Nile Rodgers', year: '2023', genre: 'K-Pop' },
    ...
    { title: 'Alcohol-Free', artist: 'TWICE', year: '2021', genre: 'K-Pop' },
    ...
    { title: 'Chk Chk Boom', artist: 'Stray Kids', year: '2024', genre: 'K-Pop' },
    ...
    { title: 'Left & Right', artist: 'SEVENTEEN', year: '2020', genre: 'K-Pop' },
    ...
    { title: 'Gee', artist: 'Girls\' Generation (SNSD)', year: '2009', genre: 'K-Pop' },
  ...
  arabic: [
    // Arabic Pop & Middle Eastern Hits
    ...
    { title: 'Ana Mahma Kbert Soiyer', artist: 'Amr Diab', year: '2003', genre: 'Arabic Pop' },
    { title: 'Habibi Ya Nour El Ain', artist: 'Amr Diab', year: '1996', genre: 'Arabic Pop' },
    { title: 'El Ghazala Rayka', artist: 'Karim Mahmoud & Mohamed Osama', year: '2021', genre: 'Arabic Pop / Egyptian' },
    { title: 'Sidi Mansour (Ya Baba)', artist: 'Saber Rebai', year: '2000', genre: 'Arabic Folk / Pop' },
    { title: 'C\'est La Vie', artist: 'Khaled', year: '2012', genre: 'Arabic Raï / Pop' },
    { title: 'Didi', artist: 'Khaled', year: '1991', genre: 'Arabic Raï' },
    { title: 'Aicha', artist: 'Khaled', year: '1996', genre: 'Arabic Raï' },
    { title: 'Abdel Kader', artist: 'Khaled, Rachid Taha & Faudel', year: '1998', genre: 'Arabic Raï' },
    ...
    { title: 'Sah Sah', artist: 'Nancy Ajram & Marshmello', year: '2022', genre: 'Arabic EDM' },
    { title: 'Mish Ghadra Al Hob', artist: 'Elissa', year: '2006', genre: 'Arabic Pop' },
    ...
    { title: 'Maktooba Leek', artist: 'Elissa', year: '2016', genre: 'Arabic Pop' },
    { title: 'Lm3allem', artist: 'Saad Lamjarred', year: '2015', genre: 'Moroccan Pop' },
    { title: 'Ghaltana', artist: 'Saad Lamjarred', year: '2016', genre: 'Moroccan Pop' },
    { title: 'Ensay', artist: 'Mohamed Ramadan & Saad Lamjarred', year: '2019', genre: 'Arabic Pop / Mahraganat' },
    { title: 'Ya Lili', artist: 'Balti ft. Hamouda', year: '2017', genre: 'Tunisian Rap / Pop' },
    ...
    { title: 'Bint El Geran', artist: 'Hassan Shakosh & Omar Kamal', year: '2019', genre: 'Egyptian Mahraganat' },
    { title: 'Oud El Batal', artist: 'Hassan Shakosh & Omar Kamal', year: '2020', genre: 'Egyptian Mahraganat' },
    { title: 'Leena Raqsa', artist: 'Carmen Soliman', year: '2020', genre: 'Arabic Pop' },
    { title: 'Boushret Kheir', artist: 'Hussain Al Jassmi', year: '2014', genre: 'Khaleeji / Egyptian Pop' },
    { title: 'Bel Bont El Areed', artist: 'Hussain Al Jassmi', year: '2020', genre: 'Arabic Pop' },
    { title: 'Faqadtek', artist: 'Hussain Al Jassmi', year: '2004', genre: 'Khaleeji Pop' },
    { title: 'Dunya Ya Ghoraba', artist: 'Maher Zain', year: '2020', genre: 'Arabic Nasheed / Pop' },
    { title: 'Ya Nabi Salam Alayka', artist: 'Maher Zain', year: '2011', genre: 'Arabic / Islamic Pop' },
    { title: 'Kun Anta', artist: 'Humood Alkhudher', year: '2015', genre: 'Kuwaiti / Arabic Pop' },
    { title: 'Dhad', artist: 'Humood Alkhudher', year: '2020', genre: 'Arabic Pop' },
    { title: 'Ha Hawa', artist: 'Sherine', year: '2018', genre: 'Arabic Pop' },
  ...
  thailand: [
    // T-Pop & Thai Hits
    { title: 'Snooze (เอาแต่ใจ)', artist: 'Three Man Down', year: '2021', genre: 'Thai Pop / Rock' },
    { title: 'Fon Tok Mai (ฝนตกไหม)', artist: 'Three Man Down', year: '2019', genre: 'Thai Pop / Rock' },
    { title: 'Khwam Lap Nang Fa (ความลับนางฟ้า)', artist: 'Three Man Down', year: '2023', genre: 'Thai Pop / Rock' },
    { title: 'Tha Ter Rak Chan Jing (ถ้าเธอรักฉันจริง)', artist: 'Three Man Down', year: '2020', genre: 'Thai Pop / Rock' },
    { title: 'Drunk (เมา)', artist: 'Three Man Down', year: '2022', genre: 'Thai Pop' },
    { title: 'Khon Rao Cha Rak Kan Dai Sak Tao Rai (คนเราจะรักกันได้สักเท่าไหร่)', artist: 'Tilly Birds', year: '2021', genre: 'Thai Pop' },
    { title: 'Same Page? (คิด(แต่ไม่)ถึง)', artist: 'Tilly Birds', year: '2020', genre: 'Thai Pop / Indie' },
    { title: 'Until Then (เพื่อนเล่น ไม่เล่นเพื่อน)', artist: 'Tilly Birds ft. MILLI', year: '2021', genre: 'Thai Pop' },
    { title: 'Just Being Friendly', artist: 'Tilly Birds ft. MILLI', year: '2021', genre: 'Thai Pop' },
    { title: 'Melt (ละลาย)', artist: 'Four-Mod', year: '2007', genre: 'T-Pop Nostalgia' },
    { title: 'Mirror Mirror', artist: 'F.HERO x MILLI ft. Changbin', year: '2021', genre: 'Thai Hip-Hop' },
    { title: '1789 (สุดปัง)', artist: 'MILLI', year: '2020', genre: 'Thai Hip-Hop' },
    { title: 'Pak Kon (พักก่อน)', artist: 'MILLI', year: '2020', genre: 'Thai Hip-Hop' },
    { title: 'Fire Boy', artist: 'PP Krit', year: '2022', genre: 'T-Pop' },
    { title: 'I\'ll Do It How You Like It', artist: 'PP Krit', year: '2022', genre: 'T-Pop' },
    { title: 'Hesitate', artist: 'PP Krit', year: '2023', genre: 'T-Pop' },
    { title: 'Skyline (กีดกัน)', artist: 'Billkin', year: '2020', genre: 'Thai OST (I Told Sunset About You)' },
    { title: 'I Like Myself with You', artist: 'Billkin', year: '2022', genre: 'T-Pop' },
    { title: 'Mr. Everything', artist: 'Billkin', year: '2022', genre: 'T-Pop' },
    { title: 'How About Now (กอดในใจ)', artist: 'Billkin ft. Jaylerr', year: '2020', genre: 'T-Pop' },
    { title: 'Booty Bomb', artist: '4EVE', year: '2021', genre: 'T-Pop (Girl Group)' },
    { title: 'Measure Yes (วัดปะหล่ะ?)', artist: '4EVE', year: '2021', genre: 'T-Pop' },
    { title: 'Hot 2 Hot', artist: '4EVE', year: '2024', genre: 'T-Pop' },
    { title: 'Vroom Vroom', artist: '4EVE', year: '2023', genre: 'T-Pop' },
    { title: 'Jackpot', artist: '4EVE', year: '2022', genre: 'T-Pop' },
    { title: 'Doo Dee (ดูดี)', artist: 'Polycat', year: '2019', genre: 'Thai Synth-Pop' },
    { title: 'Alright (อาวรณ์)', artist: 'Polycat', year: '2018', genre: 'Thai Synth-Pop' },
    { title: 'The Lawyer (พบกันใหม่)', artist: 'Polycat', year: '2015', genre: 'Thai Synth-Pop' },
    { title: 'I\'m Not Cool (เป็นทุกอย่าง)', artist: 'Room39', year: '2017', genre: 'Thai Pop' },
    { title: 'Bok Tua Eng (บอกตัวเอง)', artist: 'Room39 ft. Pongkool', year: '2018', genre: 'Thai Pop' },
    { title: 'Khwam Jing (ความจริง)', artist: 'Room39', year: '2015', genre: 'Thai Pop' },
    { title: 'Ploi (ปล่อย)', artist: 'NUM KALA', year: '2020', genre: 'Thai Rock' },
    { title: 'Rao Lae Nai (เราและนาย)', artist: 'LOSO', year: '1998', genre: 'Thai Rock Classic' },
    { title: 'Jai Sang Ma (ใจสั่งมา)', artist: 'LOSO', year: '2000', genre: 'Thai Rock Classic' },
    { title: 'Som San (ซมซาน)', artist: 'LOSO', year: '1998', genre: 'Thai Rock Classic' },
    { title: 'Khuen Chan (คืนจันทร์)', artist: 'LOSO', year: '2000', genre: 'Thai Rock Classic' },
    { title: 'Khu Chiwit (คู่ชีวิต)', artist: 'Cocktail', year: '2014', genre: 'Thai Rock' },
    { title: 'Ther (เธอ)', artist: 'Cocktail', year: '2014', genre: 'Thai Rock' },
    { title: 'Kook Khao (คุกเข่า)', artist: 'Cocktail', year: '2012', genre: 'Thai Rock' },
    { title: 'Klap Ma Pen Muang Derm Dai Mai (กลับมาเป็นเหมือนเดิมได้ไหม)', artist: 'Crescendo', year: '2010', genre: 'Thai Pop' }
  ],
  latin: [
    // Latin Pop & Reggaeton
    { title: 'Despacito', artist: 'Luis Fonsi ft. Daddy Yankee', year: '2017', genre: 'Latin Pop / Reggaeton' },
    { title: 'Echame La Culpa', artist: 'Luis Fonsi & Demi Lovato', year: '2017', genre: 'Latin Pop' },
    { title: 'Gasolina', artist: 'Daddy Yankee', year: '2004', genre: 'Reggaeton Classic' },
    ...
    { title: 'Tití Me Preguntó', artist: 'Bad Bunny', year: '2022', genre: 'Latin Urban' },
    ...
    { title: 'Monaco', artist: 'Bad Bunny', year: '2023', genre: 'Latin Trap' },
    ...
    { title: 'Safari', artist: 'J Balvin ft. Pharrell Williams', year: '2016', genre: 'Reggaeton' },
    { title: 'Hawai', artist: 'Maluma', year: '2020', genre: 'Latin Pop' },
    { title: 'Felices los 4', artist: 'Maluma', year: '2017', genre: 'Reggaeton' },
    { title: 'Corazon', artist: 'Maluma ft. Nego do Borel', year: '2017', genre: 'Latin Pop' },
    { title: 'Hips Don\'t Lie', artist: 'Shakira ft. Wyclef Jean', year: '2006', genre: 'Latin Pop' },
    { title: 'Waka Waka (This Time for Africa)', artist: 'Shakira', year: '2010', genre: 'Latin Pop' },
    { title: 'Chantaje', artist: 'Shakira ft. Maluma', year: '2016', genre: 'Reggaeton' },
    ...
    { title: 'Bailando', artist: 'Enrique Iglesias ft. Descemer Bueno', year: '2014', genre: 'Latin Pop' },
    ...
    { title: 'Calma (Remix)', artist: 'Pedro Capo & Farruko', year: '2018', genre: 'Latin Pop' },
    { title: 'La Bicicleta', artist: 'Carlos Vives & Shakira', year: '2016', genre: 'Vallenato / Pop' },
    { title: 'Vivir Mi Vida', artist: 'Marc Anthony', year: '2013', genre: 'Salsa / Latin' }
  ]
};

const filePath = path.join(__dirname, 'quizSongs.json');
fs.writeFileSync(filePath, JSON.stringify(catalog, null, 2), 'utf8');
console.log('✅ quizSongs.json berhasil dibuat dengan ratusan lagu hits dari berbagai negara!');
